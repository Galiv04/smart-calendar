  ...
  currentMonthEvents.forEach((e) => {
    ...
    if (e.day == selectedDayNumber) {
      e.events.forEach((event) => {
        ...
        list.innerHTML =
          list.innerHTML +
          `<button onclick="removeListEvents(humanStartDate.day, humanStartDate.month, humanStartDate.year, event )" style="transform: translate(7px,10px) scale(1.2); padding: 0; float: right;" > <ion-icon name="close-circle"></ion-icon> </button>
          <li class="events__item-${event.color}" 
